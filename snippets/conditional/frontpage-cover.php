...
.er-cover > .erc-shade{opacity: 0; transition: opacity .9s ease-out}
.er-cover.is-ready > .erc-shade{opacity: 1}
...
@media (prefers-reduced-motion: reduce){
	.er-cover > .erc-shade{transition: none}
...
function er_frontpage_cover_svg() {
	return <<<'SVG'
<svg class="erc-map" viewBox="0 101.1 2000 1292.9" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" focusable="false">
...
<svg class="erc-shade" viewBox="0 101.1 2000 1292.9" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" focusable="false">
<defs>
...
(() => {
	...
	/* Vertical extent of .erc-land in map units. It must match the viewBox the
	   SVGs are printed with (0 101.1 2000 1292.9); update both if the land data changes. */
	const LAND = { top: 101.1, bot: 1394 };
	const SSR_BOX = '0 101.1 2000 1292.9';
