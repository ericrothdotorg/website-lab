...
add_action('wp_head', function() use ($counter_pages) {
    ...
    <style>
        ...
        .counter-grid .counter-card {margin: 10px auto; border-radius: 50%; display: flex; align-items: center; justify-content: center; width: var(--disc-size); max-width: 100%; aspect-ratio: 1 / 1; transition: transform 0.2s ease, background 0.2s ease;}
