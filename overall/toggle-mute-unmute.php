...
add_action('wp_footer', function () {
    ...
    <style>
        ...
        #tts-toggle-btn label {background: #3A4F66; border: 1px solid #192a3d; border-radius: 50px; cursor: pointer; display: inline-block; position: relative; transition: all 0.3s; width: 50px; height: 25px;}
        #tts-toggle-btn label::after {background: #192a3d; border-radius: 50%; content: ''; position: absolute; left: 1px; top: 1px; transition: all 0.3s; width: 21px; height: 21px;}
        #tts-toggle-btn input[type='checkbox']:checked ~ label {background: #0f1924; border-color: #3A4F66;}
        #tts-toggle-btn input[type='checkbox']:checked ~ label::after {background: #3A4F66; transform: translateX(25px);}
