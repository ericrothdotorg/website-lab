...
// ======================================
// SLICK SLIDER & ANIMATE: BASICS
// ======================================

// Enqueue Frontend Assets from local Files
...
// ======================================
// SLICK SLIDER: Criticals in Head
// ======================================
    ...
    <script>
		(function() {
			...
			function initSlick() {
				...
				var sliderConfigs = [
					{
						selector: '.slideshow-single-item',
						config: {
							arrows: false,
							dots: true,
							fade: true,
					...
					{
						selector: '.slideshow-single-item-no-dots',
						config: {
							arrows: false,
							dots: false,
							fade: false,
					...
					{
						selector: '.slideshow-multiple-items-3',
						config: {
							arrows: false,
							dots: true,
							fade: false,
					...
					{
						selector: '.slideshow-multiple-items-4',
						config: {
							arrows: true,
							dots: false,
							fade: false,
					...
					{
						selector: '.slideshow-multiple-items-vertical',
						config: {
							arrows: false,
							dots: false,
							fade: false,
					...
					{
						selector: '.slideshow-multiple-items-center-mode',
						config: {
							arrows: false,
							dots: true,
							fade: false,
				...
				// Initialize only existing Sliders
				sliderConfigs.forEach(function(slider) {
					if ($(slider.selector).length) {
						$(slider.selector).slick($.extend({}, baseConfig, slider.config));
					}
				});
			}
			...
			function scheduleInitialization() {
				if ('requestIdleCallback' in window) {
					requestIdleCallback(initFrontendEnhancements, { timeout: 500 });
				} else {
					setTimeout(initFrontendEnhancements, 200);
				}
			}
