...
function q_register_post_type() {
    ...
    register_post_type( 'quotes', array(
        'labels' => array(
            ...
            'menu_name'          => esc_html__( 'Quotes', 'textdomain' ),
            ...
            'all_items'          => esc_html__( 'All Quotes', 'textdomain' ),
        ...
        'public'         => true,       // sets publicly_queryable, exclude_from_search, show_in_nav_menus
        'show_ui'        => true,
