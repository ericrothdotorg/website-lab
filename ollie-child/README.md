...
In the live site environment, all files for Eric Slider sit in [my-assets](https://github.com/ericrothdotorg/website-lab/tree/main/ollie-child/my-assets). Here on Github they are available in the separate repo [eric-slider](https://github.com/ericrothdotorg/eric-slider) so you can grab it as an isolated plugin.
