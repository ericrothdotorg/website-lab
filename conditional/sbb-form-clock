...
add_action('wp_footer', function () {
	...
	<script>
		...
		function callSBB() {
			const sbbfrom = document.getElementById('from').value;
			const sbbto = document.getElementById('to').value;
			const sbbdate = document.getElementById('date').value;
			const sbbtime = document.getElementById('time').value;
			let arrival = "";
			...
			const url = `https://www.sbb.ch/en/buying/pages/fahrplan/fahrplan.xhtml?von=${sbbfrom}&nach=${sbbto}&datum=${sbbdate}&zeit=${sbbtime}&an=${arrival}&suche=true`;
