...
add_action('wp_footer', function () {
    if (is_page(array('59525')) || is_single(array(''))) {
        ?>
        <script type="application/ld+json">
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "Is it FAQ or F*CK?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "FAQ stands for Frequently Asked Questions. It’s a list of common questions with its answers. F*CK, on the other hand, is one of the most interesting words in the English language today."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Let’s get social but not socialized → Get in touch and contact me. Find my digital name card, QR code and contact form in the contact page."
              }
            },
            {
              "@type": "Question",
            ...
            {
              "@type": "Question",
              "name": "Is there a forum?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yep. Your online discussion board providing space for engaging conversations on specific topics and shared interests across this website."
              }
            },
            {
              "@type": "Question",
